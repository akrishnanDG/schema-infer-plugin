...
class TestSchemaInference:
    ...
    def test_nullable_fields(self):
        ...
        data = [{"field": "value"}, {"field": None}, {"field": "another_value"}]
    ...
    def test_union_types(self):
        ...
        data = [{"field": "string"}, {"field": 42}, {"field": True}, {"field": None}]
    ...
    def test_max_depth_limiting(self):
        ...
        data = [
            {
                "level1": {
                    "level2": {"level3": {"level4": {"level5": {"level6": "deep"}}}}
                }
            }
        ]
